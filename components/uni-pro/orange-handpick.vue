    ...
    <view style="background: white;padding:16px;border-bottom: 1px solid #F6F6F6">
        ...
        <view style="display: flex">
            ...
            <view class="box-name">
                ...
                <view style="width: 25%;text-align:center;border-radius: 16px;border: 1px solid #e10a07;color: #e10a07;padding: 1px 6px 1px 6px"
                      @click="openGoods()">
                    立即领券
                </view>
            </view>
            ...
            copyHref() {
                ...
                if (relation_id) {
                    uni.setClipboardData({
                        ...
                        success: (r => {
                            this.$queue.showToast("素材复制成功，长按下方图片保存素材")
                        }),
                    })
                } else {
                    uni.setClipboardData({
